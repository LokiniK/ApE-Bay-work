...
/datum/map/torch/get_map_info()
	. = list()
	. +=  "Вы находитесь на борту " + replacetext("<b>[station_name]</b>", "\improper", "") + ", an Expeditionary Corps starship. Its primary mission is looking for undiscovered sapient alien species, and general exploration along the way."
